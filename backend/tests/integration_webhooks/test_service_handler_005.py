"""Unit tests for integration_webhooks handler node 005."""
import pytest
from backend.services.integration_webhooks.service_handler_005 import ServiceHandlerNode005, TaskPayload005
