"""Unit tests for integration_webhooks handler node 026."""
import pytest
from backend.services.integration_webhooks.service_handler_026 import ServiceHandlerNode026, TaskPayload026
