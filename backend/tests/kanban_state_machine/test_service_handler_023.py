"""Unit tests for kanban_state_machine handler node 023."""
import pytest
from backend.services.kanban_state_machine.service_handler_023 import ServiceHandlerNode023, TaskPayload023
