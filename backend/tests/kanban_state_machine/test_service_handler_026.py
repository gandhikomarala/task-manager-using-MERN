"""Unit tests for kanban_state_machine handler node 026."""
import pytest
from backend.services.kanban_state_machine.service_handler_026 import ServiceHandlerNode026, TaskPayload026
