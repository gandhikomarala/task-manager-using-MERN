"""Unit tests for kanban_state_machine handler node 020."""
import pytest
from backend.services.kanban_state_machine.service_handler_020 import ServiceHandlerNode020, TaskPayload020
