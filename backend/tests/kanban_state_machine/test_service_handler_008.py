"""Unit tests for kanban_state_machine handler node 008."""
import pytest
from backend.services.kanban_state_machine.service_handler_008 import ServiceHandlerNode008, TaskPayload008
