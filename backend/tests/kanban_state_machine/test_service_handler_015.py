"""Unit tests for kanban_state_machine handler node 015."""
import pytest
from backend.services.kanban_state_machine.service_handler_015 import ServiceHandlerNode015, TaskPayload015
