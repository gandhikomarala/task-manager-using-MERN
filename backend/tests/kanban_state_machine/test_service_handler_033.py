"""Unit tests for kanban_state_machine handler node 033."""
import pytest
from backend.services.kanban_state_machine.service_handler_033 import ServiceHandlerNode033, TaskPayload033
