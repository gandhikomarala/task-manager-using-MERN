"""Unit tests for kanban_state_machine handler node 036."""
import pytest
from backend.services.kanban_state_machine.service_handler_036 import ServiceHandlerNode036, TaskPayload036
